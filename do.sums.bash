...
WPWD="$PWD"
_IFBINEXT_() {
	[ -d "$HOME/bin" ] && cd "$HOME/bin" && "curl -OL https://raw.githubusercontent.com/BuildAPKs/maintenance.BuildAPKs/master/$SCMD" && chmod 700 "$SCMD" ; cd "$WPWD" ; find . -type f -name "*.swp" -delete
}
SCMD="sn.sh"
